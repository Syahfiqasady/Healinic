...
import 'package:fyp_healinic_app/diary/checkin_feeling.dart';
  ...
  createAlertDialog(BuildContext context) {
    return showDialog(
        ...
        builder: (context) {
          return AlertDialog(
            title: Text(
              "How do you feel today? \n Click Check in to record your moment and feeling.",
                      ...
                      children: <Widget>[
                        Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            color: HealinicTheme.nearlyWhite.withOpacity(0.2),
                          ),
