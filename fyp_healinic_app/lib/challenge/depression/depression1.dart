...
class Depress1 extends StatefulWidget {
  @override
  State<Depress1> createState() => _Depress1State();
}

class _Depress1State extends State<Depress1> {
          ...
          child: Column(
            children: <Widget>[
              ...
              CheckboxListTile(
                  ...
                  subtitle: Text('Light a candle and listen to soothing music'),
              ...
              CheckboxListTile(
                  ...
                  subtitle: Text(
                      'Finish your day with a relaxing meditation exercise '),
              ...
              CheckboxListTile(
                  ...
                  subtitle: Text('Go for a 20-minute walk outside '),
              ...
              CheckboxListTile(
                  ...
                  subtitle: Text(
                      'Cook your favorite meal and take time over eating it'),
              ...
              CheckboxListTile(
                  ...
                  subtitle: Text(
                      'Be open with a friend about any built-up tension you have '),
              ...
              CheckboxListTile(
                  ...
                  subtitle: Text(
                      'Write a prioritized ‘to do’ list for your day as you wake up'),
              ...
              CheckboxListTile(
                  ...
                  subtitle: Text(
                      'Set aside uninterrupted time with family or friends'),
...
Widget _firstPopupDialog(BuildContext context) {
  return new AlertDialog(
    title: const Text('Light a candle and listen to soothing music'),
    content: new Column(
...
Widget _secondPopupDialog(BuildContext context) {
  return new AlertDialog(
    title: const Text('Finish your day with a relaxing meditation exercise '),
    content: new Column(
      mainAxisSize: MainAxisSize.min,
      crossAxisAlignment: CrossAxisAlignment.start,
      children: <Widget>[
...
Widget _thirdPopupDialog(BuildContext context) {
  return new AlertDialog(
    title: const Text('Go for a 20-minute walk outside '),
    content: new Column(
      mainAxisSize: MainAxisSize.min,
      crossAxisAlignment: CrossAxisAlignment.start,
      children: <Widget>[
...
Widget _forthPopupDialog(BuildContext context) {
  return new AlertDialog(
    title: const Text('Cook your favorite meal and take time over eating it'),
    content: new Column(
      mainAxisSize: MainAxisSize.min,
      crossAxisAlignment: CrossAxisAlignment.start,
      children: <Widget>[
...
Widget _seventhPopupDialog(BuildContext context) {
  return new AlertDialog(
    title: const Text('Set aside uninterrupted time with family or friends'),
    content: new Column(
      mainAxisSize: MainAxisSize.min,
      crossAxisAlignment: CrossAxisAlignment.start,
      children: <Widget>[
