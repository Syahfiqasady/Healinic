...
class KeningauListView extends StatelessWidget {
  const KeningauListView(
      {Key? key,
      this.keningauData,
  ...
  final KeningauListData? keningauData;
  ...
  void _launchTurnByTurnNavigationInGoogleMaps() {
    final AndroidIntent intent = AndroidIntent(
        action: 'action_view',
        data: Uri.encodeFull(
            'google.navigation:q=hospital+keningau+sabah&avoid=tf'),
