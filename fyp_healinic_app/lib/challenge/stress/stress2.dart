          ...
          child: Column(
            children: <Widget>[
              ...
              CheckboxListTile(
                  ...
                  subtitle: Text('Listen to your favorite music '),
              ...
              CheckboxListTile(
                  ...
                  subtitle: Text('Take 10 minutes to read '),
              ...
              CheckboxListTile(
                  ...
                  subtitle: Text('Budget 20 minutes of a home spa time'),
              ...
              CheckboxListTile(
                  ...
                  subtitle: Text('Practice a favorite hobby'),
              ...
              CheckboxListTile(
                  ...
                  subtitle: Text('Get distracted by a movie'),
              ...
              CheckboxListTile(
                  ...
                  subtitle: Text('Go to bed 30 minutes earlier'),
...
Widget _firstPopupDialog(BuildContext context) {
  return new AlertDialog(
    title: const Text('Listen to your favorite music '),
    content: new Column(
...
Widget _secondPopupDialog(BuildContext context) {
  return new AlertDialog(
    title: const Text('Take 10 minutes to read '),
    content: new Column(
      mainAxisSize: MainAxisSize.min,
      crossAxisAlignment: CrossAxisAlignment.start,
      children: <Widget>[
...
Widget _forthPopupDialog(BuildContext context) {
  return new AlertDialog(
    title: const Text('Budget 20 minutes of a home spa time'),
    content: new Column(
      mainAxisSize: MainAxisSize.min,
      crossAxisAlignment: CrossAxisAlignment.start,
      children: <Widget>[
...
Widget _fifthPopupDialog(BuildContext context) {
  return new AlertDialog(
    title: const Text('Practice a favorite hobby'),
    content: new Column(
      mainAxisSize: MainAxisSize.min,
      crossAxisAlignment: CrossAxisAlignment.start,
      children: <Widget>[
...
Widget _sixthPopupDialog(BuildContext context) {
  return new AlertDialog(
    title: const Text('Get distracted by a movie'),
    content: new Column(
      mainAxisSize: MainAxisSize.min,
      crossAxisAlignment: CrossAxisAlignment.start,
      children: <Widget>[
...
Widget _seventhPopupDialog(BuildContext context) {
  return new AlertDialog(
    title: const Text('Go to bed 30 minutes earlier'),
    content: new Column(
      mainAxisSize: MainAxisSize.min,
      crossAxisAlignment: CrossAxisAlignment.start,
      children: <Widget>[
