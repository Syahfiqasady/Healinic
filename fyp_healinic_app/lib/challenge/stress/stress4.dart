          ...
          child: Column(
            children: <Widget>[
              ...
              CheckboxListTile(
                  ...
                  subtitle: Text('Do something outside'),
              ...
              CheckboxListTile(
                  ...
                  subtitle: Text('Order in and watch a movie '),
              ...
              CheckboxListTile(
                  ...
                  subtitle: Text('Unfollow negative social media accounts'),
              ...
              CheckboxListTile(
                  ...
                  subtitle: Text('Have a phone-free night'),
              ...
              CheckboxListTile(
                  ...
                  subtitle: Text('Write down something good that happened'),
              ...
              CheckboxListTile(
                  ...
                  subtitle: Text('Adopt a new habit'),
              ...
              CheckboxListTile(
                  ...
                  subtitle: Text('Write down 3 things you are grateful for '),
...
Widget _firstPopupDialog(BuildContext context) {
  return new AlertDialog(
    title: const Text('Do something outside'),
    content: new Column(
...
Widget _secondPopupDialog(BuildContext context) {
  return new AlertDialog(
    title: const Text('Order in and watch a movie '),
    content: new Column(
      mainAxisSize: MainAxisSize.min,
      crossAxisAlignment: CrossAxisAlignment.start,
      children: <Widget>[
...
Widget _thirdPopupDialog(BuildContext context) {
  return new AlertDialog(
    title: const Text('Unfollow negative social media accounts'),
    content: new Column(
      mainAxisSize: MainAxisSize.min,
      crossAxisAlignment: CrossAxisAlignment.start,
      children: <Widget>[
...
Widget _forthPopupDialog(BuildContext context) {
  return new AlertDialog(
    title: const Text('Have a phone-free night'),
    content: new Column(
      mainAxisSize: MainAxisSize.min,
      crossAxisAlignment: CrossAxisAlignment.start,
      children: <Widget>[
...
Widget _fifthPopupDialog(BuildContext context) {
  return new AlertDialog(
    title: const Text('Write down something good that happened'),
    content: new Column(
      mainAxisSize: MainAxisSize.min,
      crossAxisAlignment: CrossAxisAlignment.start,
      children: <Widget>[
...
Widget _sixthPopupDialog(BuildContext context) {
  return new AlertDialog(
    title: const Text('Adopt a new habit '),
    content: new Column(
      mainAxisSize: MainAxisSize.min,
      crossAxisAlignment: CrossAxisAlignment.start,
      children: <Widget>[
...
Widget _seventhPopupDialog(BuildContext context) {
  return new AlertDialog(
    title: const Text('Write down 3 things you are grateful for '),
    content: new Column(
      mainAxisSize: MainAxisSize.min,
      crossAxisAlignment: CrossAxisAlignment.start,
      children: <Widget>[
