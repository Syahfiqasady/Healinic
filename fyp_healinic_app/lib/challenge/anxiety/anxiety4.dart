...
class Anxiety4 extends StatefulWidget {
  @override
  State<Anxiety4> createState() => _Anxiety4State();
}

class _Anxiety4State extends State<Anxiety4> {
          ...
          child: Column(
            children: <Widget>[
              ...
              CheckboxListTile(
                  ...
                  subtitle: Text('Fill in a coloring book'),
              ...
              CheckboxListTile(
                  ...
                  subtitle: Text('Try breathing exercises '),
              ...
              CheckboxListTile(
                  ...
                  subtitle: Text('Listen to mood boosting music '),
              ...
              CheckboxListTile(
                  ...
                  subtitle: Text('Get on the phone '),
              ...
              CheckboxListTile(
                  ...
                  subtitle: Text('Say positive affirmations to yourself. '),
...
Widget _firstPopupDialog(BuildContext context) {
  return new AlertDialog(
    title: const Text('Fill in a coloring book '),
    content: new Column(
...
Widget _secondPopupDialog(BuildContext context) {
  return new AlertDialog(
    title: const Text('Try breathing exercises '),
    content: new Column(
      mainAxisSize: MainAxisSize.min,
      crossAxisAlignment: CrossAxisAlignment.start,
      children: <Widget>[
...
Widget _thirdPopupDialog(BuildContext context) {
  return new AlertDialog(
    title: const Text('Listen to mood boosting music '),
    content: new Column(
      mainAxisSize: MainAxisSize.min,
      crossAxisAlignment: CrossAxisAlignment.start,
      children: <Widget>[
...
Widget _fifthPopupDialog(BuildContext context) {
  return new AlertDialog(
    title: const Text('Get on the phone '),
    content: new Column(
      mainAxisSize: MainAxisSize.min,
      crossAxisAlignment: CrossAxisAlignment.start,
      children: <Widget>[
...
Widget _seventhPopupDialog(BuildContext context) {
  return new AlertDialog(
    title: const Text('Say positive affirmations to yourself'),
    content: new Column(
      mainAxisSize: MainAxisSize.min,
      crossAxisAlignment: CrossAxisAlignment.start,
      children: <Widget>[
