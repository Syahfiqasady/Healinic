...
class Depress2 extends StatefulWidget {
  @override
  State<Depress2> createState() => _Depress2State();
}

class _Depress2State extends State<Depress2> {
          ...
          child: Column(
            children: <Widget>[
              ...
              CheckboxListTile(
                  ...
                  subtitle:
                      Text('Try 1 hour of yoga with deep breathing exercises'),
              ...
              CheckboxListTile(
                  ...
                  subtitle: Text('Practice mindfulness for 20 minutes'),
              ...
              CheckboxListTile(
                  ...
                  subtitle:
                      Text('Take 5 minutes to appreciate the beauty of nature'),
              ...
              CheckboxListTile(
                  ...
                  subtitle: Text('Treat yourself to a massage '),
              ...
              CheckboxListTile(
                  ...
                  subtitle:
                      Text('Have a tech-free day. Take 24-hour digital detox'),
              ...
              CheckboxListTile(
                  ...
                  subtitle: Text(
                      'Thank 3 peoples you’re grateful for and tell them why'),
              ...
              CheckboxListTile(
                  ...
                  subtitle:
                      Text('Write down some log-term and short-term goals'),
...
Widget _firstPopupDialog(BuildContext context) {
  return new AlertDialog(
    title: const Text('Try 1 hour of yoga with deep breathing exercises '),
    content: new Column(
...
Widget _secondPopupDialog(BuildContext context) {
  return new AlertDialog(
    title: const Text('Practice mindfulness for 20 minutes'),
    content: new Column(
      mainAxisSize: MainAxisSize.min,
      crossAxisAlignment: CrossAxisAlignment.start,
      children: <Widget>[
...
Widget _thirdPopupDialog(BuildContext context) {
  return new AlertDialog(
    title: const Text('Take 5 minutes to appreciate the beauty of nature'),
    content: new Column(
      mainAxisSize: MainAxisSize.min,
      crossAxisAlignment: CrossAxisAlignment.start,
      children: <Widget>[
...
Widget _forthPopupDialog(BuildContext context) {
  return new AlertDialog(
    title: const Text('Treat yourself to a massage '),
    content: new Column(
      mainAxisSize: MainAxisSize.min,
      crossAxisAlignment: CrossAxisAlignment.start,
      children: <Widget>[
...
Widget _fifthPopupDialog(BuildContext context) {
  return new AlertDialog(
    title: const Text('Have a tech-free day. Take 24-hour digital detox'),
    content: new Column(
      mainAxisSize: MainAxisSize.min,
      crossAxisAlignment: CrossAxisAlignment.start,
      children: <Widget>[
...
Widget _sixthPopupDialog(BuildContext context) {
  return new AlertDialog(
    title: const Text('Thank 3 peoples you’re grateful for and tell them why'),
    content: new Column(
      mainAxisSize: MainAxisSize.min,
      crossAxisAlignment: CrossAxisAlignment.start,
      children: <Widget>[
...
Widget _seventhPopupDialog(BuildContext context) {
  return new AlertDialog(
    title: const Text('Write down some log-term and short-term goals'),
    content: new Column(
      mainAxisSize: MainAxisSize.min,
      crossAxisAlignment: CrossAxisAlignment.start,
      children: <Widget>[
